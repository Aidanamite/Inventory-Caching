...
mkdir "build"
:: Copying the solution directory in the "build" folder except ".csproj, .rmod build.bat" files and "bin, obj" folders.
robocopy "%foldername%" "build" /E /XF *.csproj *.rmod build.bat /XD bin obj
